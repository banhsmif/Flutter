...
class QuizModel {
  ...
  void nextQuestion() {
    //gioi han so cau hoi de tranh crash app
  ...
  bool getAns() => _questionBank[_questionNumber].questionAns;

  void checkAnswer(bool userChoose) {
    bool correctAns = _questionBank[_questionNumber].questionAns;
    if (userChoose == correctAns) {
      print('Correct !');
